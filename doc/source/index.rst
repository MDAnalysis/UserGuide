...
packages (see :ref:`formats-label` for full information). MDAnalysis can write
most of these formats, too, together with atom selections for use in
Gromacs_, CHARMM_, VMD_ and PyMol_ (see :ref:`selection-exporters-label`). It uses Numpy_ arrays to provide a flexible and relatively fast framework for complex analysis tasks. 
